...
jsPsych.plugins["ydk"] = (function() {
	...
	plugin.trial = function(display_element, trial) {
		...
		trial.response_ends_trial_ydk = assignParameterValue(trial.response_ends_trial_ydk, true);
		...
		*/
		...
		var canvasHeight = canvas.height = window.innerHeight-300;
		...
		if (arrowArrow == '<p style="font-size: 90px;">&#x2193</p>'){
			cuedShown = 2 //down
		}
		if (arrowArrow == '<p style="font-size: 90px;">&#x2190</p>' ){
			cuedShown = 3 //left
		}
        ...
        html += '<div id="jspsych-canvas-slider-response-stimulus">' + '<canvas id="jspsych-canvas-stimulus" height="' + 50 + '" width="' + trial.canvas_size[1] + '"></canvas>' + '</div>';
		...
		//display_element.querySelector('#jspsych-canvas-slider-response-response').addEventListener('input', myFunction);
		...
		ellipse1_height = jsPsych.data.get().last(3).values()[1].foreground_aperture_height
		ellipse1_width = jsPsych.data.get().last(3).values()[1].foreground_aperture_width
		ellipse2_height =  jsPsych.data.get().last(3).values()[1].foreground_aperture_height_2
		ellipse2_width = jsPsych.data.get().last(3).values()[1].foreground_aperture_width_2

		if (jsPsych.data.get().last(1).values()[0].cue_type == 1) {
			cuedMotionDirection = jsPsych.data.get().last(3).values()[1].coherent_direction_1
			unCuedMotionDirection = jsPsych.data.get().last(3).values()[1].coherent_direction_2
			//cued ellipse is 1
			if (ellipse1_height == 75.08 & ellipse1_width == 218.18){
				cuedEllipse_logAR = -0.463318662
			}
			if (ellipse1_height == 79.19 & ellipse1_width == 206.85){
				cuedEllipse_logAR = -0.416986843
			}
			if (ellipse1_height == 83.56 & ellipse1_width == 196.17){
				cuedEllipse_logAR = -0.370655025
			}
			if (ellipse1_height == 88.14 & ellipse1_width == 185.99){
				cuedEllipse_logAR = -0.324323207
			}
			if (ellipse1_height == 92.96 & ellipse1_width == 176.31){
				cuedEllipse_logAR = -0.277991389
			}
			if (ellipse1_height == 98.04 & ellipse1_width == 167.13){
				cuedEllipse_logAR = -0.231659571
			}
			if (ellipse1_height == 103.42 & ellipse1_width == 158.46){
				cuedEllipse_logAR = -0.185327753
			}
			if (ellipse1_height == 109.08 & ellipse1_width == 150.22){
				cuedEllipse_logAR = -0.138995934
			}
			if (ellipse1_height == 115.07 & ellipse1_width == 142.44){
				cuedEllipse_logAR = -0.092664116
			}
			...
			if (ellipse1_height == 142.44 & ellipse1_width == 115.07){
				cuedEllipse_logAR = 0.092663157
			}
			if (ellipse1_height == 150.22 & ellipse1_width == 109.08){
				cuedEllipse_logAR = 0.138994975
			}
			if (ellipse1_height == 158.46 & ellipse1_width == 103.42){
				cuedEllipse_logAR = 0.185326793
			}
			if (ellipse1_height == 167.13 & ellipse1_width == 98.04){
				cuedEllipse_logAR = 0.231658611
			}
			if (ellipse1_height == 176.31 & ellipse1_width == 92.96){
				cuedEllipse_logAR = 0.277990429
			}
			if (ellipse1_height == 185.99 & ellipse1_width == 88.14){
				cuedEllipse_logAR = 0.324322247
			}
			if (ellipse1_height == 196.17 & ellipse1_width == 83.56){
				cuedEllipse_logAR = 0.370654066
			}
			if (ellipse1_height == 206.85 & ellipse1_width == 79.19){
				cuedEllipse_logAR = 0.416985884
			}
			if (ellipse1_height == 218.18 & ellipse1_width == 75.08){
				cuedEllipse_logAR = 0.463317702
			}
			//uncued
			//uncued
			if (ellipse2_height == 75.08 & ellipse2_width == 218.18){
				uncuedEllipse_logAR = -0.463318662
			}
			if (ellipse2_height == 79.19 & ellipse2_width == 206.85){
				uncuedEllipse_logAR = -0.416986843
			}
			if (ellipse2_height == 83.56 & ellipse2_width == 196.17){
				uncuedEllipse_logAR = -0.370655025
			}
			if (ellipse2_height == 88.14 & ellipse2_width == 185.99){
				uncuedEllipse_logAR = -0.324323207
			}
			if (ellipse2_height == 92.96 & ellipse2_width == 176.31){
				uncuedEllipse_logAR = -0.277991389
			}
			if (ellipse2_height == 98.04 & ellipse2_width == 167.13){
				uncuedEllipse_logAR = -0.231659571
			}
			if (ellipse2_height == 103.42 & ellipse2_width == 158.46){
				uncuedEllipse_logAR = -0.185327753
			}
			if (ellipse2_height == 109.08 & ellipse2_width == 150.22){
				uncuedEllipse_logAR = -0.138995934
			}
			if (ellipse2_height == 115.07 & ellipse2_width == 142.44){
				uncuedEllipse_logAR = -0.092664116
			}
			...
			if (ellipse2_height == 142.44 & ellipse2_width == 115.07){
				uncuedEllipse_logAR = 0.092663157
			}
			if (ellipse2_height == 150.22 & ellipse2_width == 109.08){
				uncuedEllipse_logAR = 0.138994975
			}
			if (ellipse2_height == 158.46 & ellipse2_width == 103.42){
				uncuedEllipse_logAR = 0.185326793
			}
			if (ellipse2_height == 167.13 & ellipse2_width == 98.04){
				uncuedEllipse_logAR = 0.231658611
			}
			if (ellipse2_height == 176.31 & ellipse2_width == 92.96){
				uncuedEllipse_logAR = 0.277990429
			}
			if (ellipse2_height == 185.99 & ellipse2_width == 88.14){
				uncuedEllipse_logAR = 0.324322247
			}
			if (ellipse2_height == 196.17 & ellipse2_width == 83.56){
				uncuedEllipse_logAR = 0.370654066
			}
			if (ellipse2_height == 206.85 & ellipse2_width == 79.19){
				uncuedEllipse_logAR = 0.416985884
			}
		...
		function showingStarterRatio(){
			if (trial.slider_start == 1){
				apertureWidth = 63.99;
				apertureHeight = 256.11;
			}
			else if (trial.slider_start == 2){
				apertureWidth = 67.50;
				apertureHeight = 242.82;
			}
			else if (trial.slider_start == 3){
				apertureWidth = 71.18;
				apertureHeight = 230.13;
			}
			else if (trial.slider_start == 4){
				apertureWidth = 75.08;
				apertureHeight = 218.18;
			}
			else if (trial.slider_start == 5){
				apertureWidth = 79.19;
				apertureHeight = 206.85;
			}
			else if (trial.slider_start == 6){
				apertureWidth = 83.56;
				apertureHeight = 196.17;
			}
			else if (trial.slider_start == 7){
				apertureWidth = 88.14;
				apertureHeight = 185.99;
			}
			else if (trial.slider_start == 8){
				apertureWidth = 92.96;
				apertureHeight = 176.31;
			}
			else if (trial.slider_start == 9){
				apertureWidth = 98.04;
				apertureHeight = 167.13;
			}
			else if (trial.slider_start == 10){
				apertureWidth = 103.42;
				apertureHeight = 158.46;
			}
			else if (trial.slider_start == 11){
				apertureWidth = 109.08;
				apertureHeight = 150.22;
			}
			else if (trial.slider_start == 12){
				apertureWidth = 115.07;
				apertureHeight = 142.44;
			}
			else if (trial.slider_start == 13){
				apertureWidth = 121.38;
				apertureHeight = 135.05;
			}
			else if (trial.slider_start == 14){
				apertureWidth = 128.03;
				apertureHeight = 128.03;
			}
			else if (trial.slider_start == 15){
				apertureWidth = 135.05;
				apertureHeight = 121.38;
			}
			else if (trial.slider_start == 16){
				apertureWidth = 142.44;
				apertureHeight = 115.07;
			}
			else if (trial.slider_start == 17){
				apertureWidth = 150.22;
				apertureHeight = 109.08;
			}
			else if (trial.slider_start == 18){
				apertureWidth = 158.46;
				apertureHeight = 103.42;
			}
			else if (trial.slider_start == 19){
				apertureWidth = 167.13;
				apertureHeight = 98.04;
			}
			else if (trial.slider_start == 20){
				apertureWidth = 176.31;
				apertureHeight = 92.96;
			}
			else if (trial.slider_start == 21){
				apertureWidth = 185.99;
				apertureHeight = 88.14;
			}
			else if (trial.slider_start == 22){
				apertureWidth = 196.17;
				apertureHeight = 83.56;
			}
			else if (trial.slider_start == 23){
				apertureWidth = 206.85;
				apertureHeight = 79.19;
			}
			else if (trial.slider_start == 24){
				apertureWidth = 218.18;
				apertureHeight = 75.08;
			}
			else if (trial.slider_start == 25){
				apertureWidth = 230.13;
				apertureHeight = 71.18;
			}
			else if (trial.slider_start == 26){
				apertureWidth = 242.82;
				apertureHeight = 67.50;
			}
			else if (trial.slider_start == 27){
				apertureWidth = 256.11;
				apertureHeight = 63.99;
			}
		}
		...
		display_element.querySelector('#jspsych-canvas-slider-response-response').addEventListener('input', function () {
			//response.slider_value = document.querySelector('input').value;
			// Set up multiple apertures
			var selectedValue = document.querySelector('input').value
			if (selectedValue == 1){
				apertureWidth = 63.99;
				apertureHeight = 256.11;
				selectedAperture_logAR = 0.602314116
			}
			if (selectedValue == 2){
				apertureWidth = 67.50;
				apertureHeight = 242.82;
				selectedAperture_logAR = 0.555981338
			}
			if (selectedValue == 3){
				apertureWidth = 71.18;
				apertureHeight = 230.13;
				selectedAperture_logAR = 0.50964952
			}
			if (selectedValue == 4){
				apertureWidth = 75.08;
				apertureHeight = 218.18;
				selectedAperture_logAR = 0.463317702
			}
			if (selectedValue == 5){
				apertureWidth = 79.19;
				apertureHeight = 206.85;
				selectedAperture_logAR = 0.416985884
			}
			if (selectedValue == 6){
				apertureWidth = 83.56;
				apertureHeight = 196.17;
				selectedAperture_logAR = 0.370654066
			}
			if (selectedValue == 7){
				apertureWidth = 88.14;
				apertureHeight = 185.99;
				selectedAperture_logAR = 0.324322247
			}
			if (selectedValue == 8){
				apertureWidth = 92.96;
				apertureHeight = 176.31;
				selectedAperture_logAR = 0.277990429
			}
			if (selectedValue == 9){
				apertureWidth = 98.04;
				apertureHeight = 167.13;
				selectedAperture_logAR = 0.231658611
			}
			if (selectedValue == 10){
				apertureWidth = 103.42;
				apertureHeight = 158.46;
				selectedAperture_logAR = 0.185326793
			}
			if (selectedValue == 11){
				apertureWidth = 109.08;
				apertureHeight = 150.22;
				selectedAperture_logAR = 0.138994975
			}
			if (selectedValue == 12){
				apertureWidth = 115.07;
				apertureHeight = 142.44;
				selectedAperture_logAR = 0.092663157
			}
			if (selectedValue == 13){
				apertureWidth = 121.38;
				apertureHeight = 135.05;
				selectedAperture_logAR = 0.046331338
			}
			if (selectedValue == 14){
				apertureWidth = 128.03;
				apertureHeight = 128.03;
				selectedAperture_logAR = -0.000000479895668
			}
			if (selectedValue == 15){
				apertureWidth = 135.05;
				apertureHeight = 121.38;
				selectedAperture_logAR = -0.046332298
			}
			if (selectedValue == 16){
				apertureWidth = 142.44;
				apertureHeight = 115.07;
				selectedAperture_logAR = -0.092664116
			}
			if (selectedValue == 17){
				apertureWidth = 150.22;
				apertureHeight = 109.08;
				selectedAperture_logAR = -0.138995934
			}
			if (selectedValue == 18){
				apertureWidth = 158.46;
				apertureHeight = 103.42;
				selectedAperture_logAR = -0.185327753
			}
			if (selectedValue == 19){
				apertureWidth = 167.13;
				apertureHeight = 98.04;
				selectedAperture_logAR = -0.231659571
			}
			if (selectedValue == 20){
				apertureWidth = 176.31;
				apertureHeight = 92.96;
				selectedAperture_logAR = -0.277991389
			}
			if (selectedValue == 21){
				apertureWidth = 185.99;
				apertureHeight = 88.14;
				selectedAperture_logAR = -0.324323207
			}
			if (selectedValue == 22){
				apertureWidth = 196.17;
				apertureHeight = 83.56;
				selectedAperture_logAR = -0.370655025
			}
			if (selectedValue == 23){
				apertureWidth = 206.85;
				apertureHeight = 79.19;
				selectedAperture_logAR = -0.416986843
			}
			if (selectedValue == 24){
				apertureWidth = 218.18;
				apertureHeight = 75.08;
				selectedAperture_logAR = -0.463318662
			}
			if (selectedValue == 25){
				apertureWidth = 230.13;
				apertureHeight = 71.18;
				selectedAperture_logAR = -0.50965048
			}
			if (selectedValue == 26){
				apertureWidth = 242.82;
				apertureHeight = 67.50;
				selectedAperture_logAR = -0.555982298
			}
			if (selectedValue == 27){
				apertureWidth = 256.11;
				apertureHeight = 63.99;
			...
			//apertureWidth = document.querySelector('input').value;
			setUpMultipleApertures();
			//console.log(apertureWidth);
        ...
        display_element.querySelector('#jspsych-canvas-slider-response-next').addEventListener('click', function () {
			...
			//var apertureWidth = response.response
            if (trial.response_ends_trial_ydk) {
                end_trial();
            } else {
		...
		function end_trial() {
			...
			var trial_data = { 
				...
				"response_ends_trial": trial.response_ends_trial_ydk, //If the response ends the trial
				...
				"finalSlider_value": response.response, 
 				...
 				"ellipse1_width"				:jsPsych.data.get().last(3).values()[1].foreground_aperture_width,
				"ellipse2_width"				:jsPsych.data.get().last(3).values()[1].foreground_aperture_width_2,
				"ellipse1_height"				:jsPsych.data.get().last(3).values()[1].foreground_aperture_height, //Applied to all apertures if only one value
				"ellipse2_height"				:jsPsych.data.get().last(3).values()[1].foreground_aperture_height_2,
				"ellipse1_AR"					:(jsPsych.data.get().last(3).values()[1].foreground_aperture_height)/(jsPsych.data.get().last(3).values()[1].foreground_aperture_width),
				"ellipse2_AR"					:(jsPsych.data.get().last(3).values()[1].foreground_aperture_height_2)/(jsPsych.data.get().last(3).values()[1].foreground_aperture_width_2),
				"shapeOrganizationNumber"		:jsPsych.data.get().last(3).values()[1].selectedShapeLocation,
				"backgroundDotFieldWidth" 		:jsPsych.data.get().last(3).values()[1].aperture_width,
				"backgroundDotFieldHeight" 		:jsPsych.data.get().last(3).values()[1].aperture_height,
				...
				"trial_num"						:jsPsych.data.get().last(3).values()[1].trial_number,
				...
				"trial_frame_rate"				:jsPsych.data.get().last(3).values()[1].frame_rate,
				"trial_number_of_frames"		:jsPsych.data.get().last(3).values()[1].number_of_frames,
				"fix_dur"				:jsPsych.data.get().last(3).values()[1].postTrial_gap,
				"ellipse1_move_direction"		:jsPsych.data.get().last(3).values()[1].coherent_direction_1,
				"ellipse2_move_direction"		:jsPsych.data.get().last(3).values()[1].coherent_direction_2,
			...
			// for ( var i = 0; i < display_element.length; i++ ){
			// 	display_element[i].remove();
			// }
